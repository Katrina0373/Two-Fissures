...
double RungeKutta1(const double alpha, const double x0, const double U1_0, const double Sigma1_0, const double x_end, const double k, double h = 0.001);
...
std::pair<cx_double, cx_double> RungeKuttaI(const cx_double alpha, const double x0, const double U2_0, const double sigma2_0, const double x_end, const double k, double h = 0.001);
